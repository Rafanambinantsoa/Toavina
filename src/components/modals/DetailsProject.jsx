// DetailsProject.jsx
import { Modal, Divider, Text, ScrollArea } from "@mantine/core";
import '../../styles/modal.css';
import '../../styles/projects/detailsproject.css';

export default function DetailsProject({ opened, onClose, clientData, projectData }) {
    // Find the corresponding client for this project
    const projectClient = clientData.find(client => client.id === projectData.client_id);
                ...
                <ScrollArea className="modal-form-section">
                    ...
                    <div className="receipt-section">
                        ...
                        <div className="client-details">
                            <p>{projectClient?.nom_client}</p>
                            <p>{projectClient?.email}</p>
                            <p>{projectClient?.contact_client}</p>
                        </div>
                    </div>
