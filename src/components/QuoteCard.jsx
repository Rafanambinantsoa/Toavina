...
const QuoteCard = () => {
    ...
    const quotes = [
        ...
        { id: 3, etat: 'en_attente', montant: 5000 },
        { id: 4, etat: 'refuse', montant: 6000 },
        { id: 5, etat: 'en_attente', montant: 4000 },
    ];
    ...
    const statistics = useMemo(() => {
        ...
        return {
            ...
            'en_attente': stats['en_attente'] || { count: 0, total: 0 },
    ...
    const statusConfig = [
        ...
        },
        {
            ...
            label: 'en attente',
            color: 'warning',
            percentage: (statistics['en_attente'].total / statistics.total) * 100
        },
        {
            key: 'refuse',
            label: 'refusés',
